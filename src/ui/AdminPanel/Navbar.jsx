            ...
            <div className="flex items-center justify-between w-[90%]">
                ...
                <div className="flex items-center justify-between w-[30%] gap-12 ">
                    ...
                    <div className="justify-between px-3 flex bg-primary-600 items-center rounded-[500px] ">
                        <input
                            className="py-2 text-white px-3 w-full bg-transparent outline-none transition-all w-[90px] focus:w-[190px]"
                            type="text"
                            placeholder="...جستجو"
                        />
                ...
                <div className="text-white  relative w-[15%]">
                    ...
                    <div className={`transition-all ${isShowAdminInfo ? "top-12" : "-top-[300px]"} absolute bg-secondary-50 text-primary-500  left-0 rounded p-2 flex
