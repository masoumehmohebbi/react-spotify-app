        ...
        <>
            <div className="w-full flex items-center justify-center mt-8">
                <div className="bg-primary-900 text-white w-max pt-24 pb-12 px-24 rounded-xl w-full flex items-center justify-center flex-col gap-12">
                    <h1 className="text-5xl font-bold tracking-wide">Register in to Spotify</h1>
                    {
                        err && (
                            <div className="bg-red-600 w-full flex items-center justify-end gap-4 px-4 py-2 rounded">
                                <p className="text-md">
                                    {err && <p>Your email is invalid</p>}
                                </p>
                    ...
                    <div className="flex w-full relative">
                        ...
                        <span className="absolute -top-[10px] z-10 right-[45%] bg-primary-900 px-4 ">or</span>
                        <div className="w-full h-[1px] bg-primary-700 rounded"></div>
                    </div>
                    ...
                    <p className="text-gray-400" >
                        ...
                        <Link to={"/login"} className="underline text-white hover:text-green-600 ml-2">
                            Log In Here
                        </Link>
                    </p>
                </div>
