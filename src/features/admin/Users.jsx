            ...
            {users.map((user) => (
              <tr key={user.id}>
                <td className="py-4 text-center px-6 border-b border-primary-200 flex items-center gap-2">
                  <span className="bg-red-600 text-white py-1 px-2 rounded-full text-[14px] cursor-pointer">
                    حذف
                  </span>
                  <span className="bg-green-600 text-white py-1 px-2 rounded-full  text-[14px] cursor-pointer">
                    تغییر نقش
                  </span>
                </td>
                ...
                <td className="py-4 text-center px-6 border-b border-primary-200 truncate">
                  {user.username}
                </td>
                <td className="py-4 text-center px-6 border-b border-primary-200">
                  {user.password}
